...
const Events = () => (
    <div id = "events-container" className="page-container">
      ...
      <ContentAreaMain id="announcements" title="Announcements" textPosition="text-left" content={announcementsContent} />
      <ContentAreaMain id="events" title="Events" textPosition="text-left" content={eventsContent} />
